...
//   if($balance>=$money){
    {
        ...
        $query = "INSERT INTO taskinfo VALUES('$t_userid','$w_desc','$doc','$toc','$city','$money','$image','$status','$hunter')";
        $query_run = mysqli_query($con, $query);
        
       if ($query_run) {
            move_uploaded_file($_FILES['image']['tmp_name'],$target);
            $sql="UPDATE info SET balance=(balance-'$money') WHERE userid LIKE '$t_userid' ";
            ...
            if (!$query_run) {
                ...
                $query_run = mysqli_query($con, $sql);
                // if (!$query_run) {
                //     echo '<script type="text/javascript"> alert("Errorfs!") </script>';
                // }
    ...
    <div id="footer">
        <center>
            <ul>
                ...
                <a href="mainpage.html"><button id="footbtn"><i class="fas fa-sign-out-alt"
                ...
                <a href=""><button id="footbtn"><i class="fa fa-cubes" aria-hidden="true" style="font-size:36px;"></i>
                        POST TASK</button></a>
                        <a href="homepage.php"><button id="footbtn"><i class="fa fa-home" 
                        style="font-size:36px;"></i>Home</button></a>
            </ul>
        </center>
...
#main_body {
    ...
    width: 100%;
    background-image: url("imgs/man5.jpg");
